...
class AppColors {
  static const  primaryColor = Color(0xFFF6F2ED);
  static const  freshMintColor = Color(0xFF4E8D7C);
  static const  brownButtonColor = Color(0xFF4B2C20);
  static const  orangeColor = Color(0xFF9C4400);
  ...
  static const  registerBGColor = Color(0xFFF8EBD8);
