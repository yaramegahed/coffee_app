...
import 'package:coffee_app/features/all_products/view/all_product_view.dart';
import 'package:coffee_app/features/auth/cubit/auth_cubit.dart';
import 'package:coffee_app/features/auth/cubit/auth_state.dart';
import 'package:coffee_app/features/home/widget/guest_widget.dart';
import 'package:coffee_app/features/home/widget/member_widget.dart';
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      CustomGridView(
                        products: state.coffee,
                        itemCount: state.coffee.take(5).length,
                      ),
                    ],
                  ),
                  Column(
                    ...
                    children: [
                      ...
                      CustomGridView(
                        products: state.cookie,
                        itemCount: state.cookie.take(5).length,
                      ),
                      SizedBox(
                        height: 20,
                      ),
